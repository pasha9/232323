...
void C_TextField::draw( ) {
	...
	if ( taking_input )
		render::get( ).text( fonts[ TAHOMA12 ], n_area.x + 10, n_area.y + 3, Color::White, HFONT_CENTERED_NONE, to_render.c_str( ) );
	else
		render::get( ).text( fonts[ TAHOMA12 ], n_area.x + 10, n_area.y + 3, Color( 220, 220, 220 ), HFONT_CENTERED_NONE, to_render.c_str( ) );
}
