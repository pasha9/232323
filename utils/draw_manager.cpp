...
void render::setup( ) {
	...
	fonts[ rolexTEXT ] = create_font( "Verdana", 12, FW_BOLD, FONTFLAG_DROPSHADOW );
	fonts[ rolexBOLD ] = create_font( "Verdana", 12, FW_BOLD, FONTFLAG_OUTLINE );
	...
	fonts[ TABFONT ] = create_font( "rolex", 12, FW_NORMAL, FONTFLAG_ANTIALIAS );
	fonts[ rolexFONT ] = create_font( "rolex", 40, FW_NORMAL, FONTFLAG_ANTIALIAS );
}
